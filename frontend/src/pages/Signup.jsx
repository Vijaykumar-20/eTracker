...
export default function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const fallback = 'Failed to sign up. User may already exist or input is invalid.';
    ...
    <>
      ...
      <div className="glass-panel animate-fade-in" style={{ padding: '2.5rem', width: '100%', maxWidth: '400px' }}>
        ...
        <p style={{ textAlign: 'center', marginTop: '1.5rem', color: 'var(--text-secondary)', fontSize: '0.875rem' }}>
          Already have an account? <Link to="/login" style={{ fontWeight: 500, color: 'var(--color-primary)' }}>Sign in</Link>
        </p>
      </div>
    </div>
    </>
